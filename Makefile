...
build/test_vector_io.o: include/routingkit/bit_vector.h include/routingkit/vector_io.h src/expect.h src/test_vector_io.cpp generate_make_file
	@mkdir -p build
	$(CC) $(CFLAGS)  -c src/test_vector_io.cpp -o build/test_vector_io.o
...
bin/test_vector_io: build/bit_vector.o build/expect.o build/test_vector_io.o build/vector_io.o
	@mkdir -p bin
	$(CC) $(LDFLAGS) build/bit_vector.o build/expect.o build/test_vector_io.o build/vector_io.o -pthread  -o bin/test_vector_io

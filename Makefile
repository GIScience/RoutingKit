...
all: bin/convert_road_dimacs_graph bin/generate_dijkstra_rank_test_queries bin/test_tag_map bin/compare_vector bin/test_customizable_contraction_hierarchy_customization bin/compute_nested_dissection_order bin/compute_geographic_distance_weights bin/test_nearest_neighbor bin/run_contraction_hierarchy_query bin/run_astar bin/examine_ch bin/test_protobuf bin/test_dijkstra bin/test_customizable_contraction_hierarchy_path_query bin/test_basic_features bin/export_road_dimacs_graph bin/test_strongly_connected_component bin/test_customizable_contraction_hierarchy_perfect_customization bin/run_dijkstra bin/generate_test_queries bin/generate_random_source_times bin/convert_road_dimacs_coordinates bin/test_buffered_asynchronous_reader bin/test_bit_vector bin/test_permutation bin/test_customizable_contraction_hierarchy bin/graph_to_svg bin/compute_contraction_hierarchy bin/test_nested_dissection bin/randomly_permute_nodes bin/test_customizable_contraction_hierarchy_pinned_query bin/generate_constant_vector bin/encode_vector bin/graph_to_dot bin/osm_extract bin/show_path bin/test_contraction_hierarchy_extra_weight bin/test_geo_dist bin/test_id_mapper bin/test_osm_simple bin/test_sort bin/generate_random_node_list bin/test_id_set_queue bin/test_contraction_hierarchy_pinned_query bin/decode_vector bin/test_inverse_vector bin/test_contraction_hierarchy_path_query bin/test_customizable_contraction_hierarchy_reset lib/libroutingkit.a lib/libroutingkit.so
...
build/run_astar.o: include/routingkit/astar.h include/routingkit/bit_vector.h include/routingkit/constants.h include/routingkit/geo_dist.h include/routingkit/id_queue.h include/routingkit/inverse_vector.h include/routingkit/min_max.h include/routingkit/permutation.h include/routingkit/sort.h include/routingkit/timer.h include/routingkit/timestamp_flag.h include/routingkit/vector_io.h src/run_astar.cpp src/verify.h generate_make_file
	@mkdir -p build
...
bin/run_astar: build/bit_vector.o build/run_astar.o build/timer.o build/vector_io.o build/verify.o
	@mkdir -p bin
	$(CC) $(LDFLAGS) build/bit_vector.o build/run_astar.o build/timer.o build/vector_io.o build/verify.o -lm -pthread  -o bin/run_astar
